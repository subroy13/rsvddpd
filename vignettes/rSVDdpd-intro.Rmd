...
```{r results='hide'}
res <- simSVD(trueSVD, svdfun = svd, B = 75, seed = 2021, outlier = TRUE, out_value = 25, tau = 0.9)
```
...
```{r results='hide'}
res <- simSVD(trueSVD, svdfun = pcaMethods::robustSvd, B = 75, seed = 2021, outlier = TRUE, out_value = 25, tau = 0.9)
```
...
```{r results='hide'}
res <- simSVD(trueSVD, svdfun = rSVDdpd, B = 75, seed = 2021, outlier = TRUE, out_value = 25, tau = 0.9, alpha = 0.25)
```
...
```{r results='hide'}
res <- simSVD(trueSVD, svdfun = rSVDdpd, B = 75, seed = 2021, outlier = TRUE, out_value = 25, tau = 0.9, alpha = 0.75)
```
